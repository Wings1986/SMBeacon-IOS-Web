...
class gmap
{
     ...
     * @param float $lng Initialer L�ngengrad
    ...
    {
        echo "
		<script type=\"text/javascript\" src = \"/backend/js/map-bodyjs.js\"></script>\n";
        return true;
    }
     ...
     * @param float $lng L�ngengrad des Markers
     ...
     * @return bool
     */
    function tabMarker($lat, $lng, $tabs, $img = "gelb.png")
    {
        if ($lat and $lng)
        {
            $str = "";
     ...
     * @param float $ lng L�ngengrad des Zentrums
     * @param int $ radius Radius des Kreises
     * @param string $ color Farbe der Kreislinie (Hexcode)
     * @param int $ line Strichst�rke der Kreislinie
     * @param string $ img Wenn ein Bild �bergeben wird, werden auf der Kreislinie Marker gesetzt.
     */
    ...
    /**
     * Blendet den Button f�r den "Gel�nde" Kartentyp ein
     *
     * @return bool
     */
    ...
    /**
     * Erzeugt ein Streetview overlay. Das Overlay zeigt alle Gegengden f�r die Streetview verf�gbar ist in blau an.
     *
     * @return bool ;
     */
    ...
    /**
     * Erzeugt ein Streetview overlay. Das Overlay zeigt alle Gegengden f�r die Streetview verf�gbar ist in blau an.
     * Wenn die Karte geklickt wird, wird Streetview im element mit der ID "pano" ge�ffnet
     *
     * @return bool ;
     */
