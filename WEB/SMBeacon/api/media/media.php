...
function wp_get_attachment_image_src($attachment_id, $size='thumbnail', $icon = false) {
	...
	if ( $icon && $src = wp_mime_type_icon($attachment_id) ) {
		$icon_dir = apply_filters( 'icon_dir', ABSPATH . WPINC . '/Brown/images/crystal' );
...
#�대�吏�� 鍮꾩쑉,�ш린���곕씪 由ъ떥�댁쫰  �섎뒗 �⑥닔
function img_resize ($img_src_file, $set_w, $set_h, $mode="s" )
{
	list ( $src_w, $src_h, $src_t, $src_a ) = getimagesize( $img_src_file );
	$set_tangent = $set_h / $set_w; //�ㅼ젙���대�吏�쓽 媛�줈�몃줈 鍮꾩쑉
	$src_tangent = $src_h / $src_w; //�뚯뒪�대�吏�쓽 媛�줈�몃줈 鍮꾩쑉
	...
	} else if($mode == "s"){// �명똿 �ш린��洹몃�濡��먮릺, �ㅼ뼱媛�뒗 �대�吏�쓽 鍮꾩쑉留��뺣�/異뺤냼���ㅼ쓬 �ｌ쓬
