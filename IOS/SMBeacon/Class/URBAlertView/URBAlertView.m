...
- (UIColor *)adjustBrightnessAlertView:(CGFloat)amount;
@end
...
- (void)setBackgroundColor:(UIColor *)backgroundColor {
	if (backgroundColor != _backgroundColor) {
		...
		[self updateBackgroundGradient];
		self.lightKeylineColor = [self.backgroundColor adjustBrightnessAlertView:1.1];
		self.darkKeylineColor = [self.backgroundColor adjustBrightnessAlertView:0.85];
		self.hatchLineColor = [self.backgroundColor adjustBrightnessAlertView:0.85];
...
- (void)updateBackgroundGradient {
	self.backgroundTopColor = (self.backgroundGradation > 0) ? [self.backgroundColor adjustBrightnessAlertView:(1.0 + self.backgroundGradation)] : self.backgroundColor;
	self.backgroundBottomColor = (self.backgroundGradation > 0) ? [self.backgroundColor adjustBrightnessAlertView:(1.0 - self.backgroundGradation)] : self.backgroundColor;
}
...
- (UIImage *)normalButtonImage {
	...
	UIColor *buttonOuterGradientColor = [self.strokeColor adjustBrightnessAlertView:1.05];
	UIColor *buttonOuterGradientColor2 = [self.strokeColor adjustBrightnessAlertView:0.95];
	UIColor *buttonInnerGradientColor = [self.backgroundColor adjustBrightnessAlertView:1.05];
	UIColor *buttonInnerGradientColor2 = [self.backgroundColor adjustBrightnessAlertView:0.95];
...
- (UIImage *)selectedButtonImage {
	...
	UIColor *buttonBgGradientColorTop = [UIColor colorWithWhite:0.3 alpha:1.0];
	UIColor *buttonBgGradientColorBottom = [UIColor colorWithWhite:0.25 alpha:1.0];
	UIColor *buttonOuterGradientColor = [self.strokeColor adjustBrightnessAlertView:0.95];
	UIColor *buttonOuterGradientColor2 = [self.strokeColor adjustBrightnessAlertView:1.05];
	UIColor *buttonInnerGradientColor = [self.backgroundColor adjustBrightnessAlertView:0.95];
	UIColor *buttonInnerGradientColor2 = [self.backgroundColor adjustBrightnessAlertView:1.05];
